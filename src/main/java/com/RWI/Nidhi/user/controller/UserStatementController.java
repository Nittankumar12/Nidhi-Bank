...
public class UserStatementController {
    ...
    public ResponseEntity<?> getFdDetails(@PathVariable("email") String email) {
        ...
        if (fdRequestDtoList == null)
            return new ResponseEntity<>("User account is inactive", HttpStatus.NOT_ACCEPTABLE);
    ...
    public ResponseEntity<?> getRdDetails(@PathVariable("email") String email) {
        ...
        if (rdRequestDtoList == null)
            return new ResponseEntity<>("user inactive list not found", HttpStatus.NOT_ACCEPTABLE);
    ...
    public ResponseEntity<?> getLoanDetails(@PathVariable("email") String email) {
        List<LoanHistoryDto> loanHistoryDto = service.getLoanDetailsByEmail(email);

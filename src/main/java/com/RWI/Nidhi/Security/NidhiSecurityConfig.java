        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/home/**"
                                ...
                                ,"/user/getTodaysTransactionForUser/**"
                                ,"/user/getYesterdaysTransactionForUser/**"
                                ,"/user/getMonthTransactionForUser/**"
...
//            .formLogin(form->form.loginPage("/home/signin").permitAll())
                .logout(log->log.logoutSuccessUrl("/logout").logoutSuccessHandler(new HttpStatusReturningLogoutSuccessHandler())
